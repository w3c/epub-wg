        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    retrieve_html = function (resolutions) {
                        var retval = '';
                        // y2k problem for the future:-)
                        var year = REMOTE_YEAR;
                    ...
                    return [4 /*yield*/, fetch(resolution_asset)];
                case 1: return [4 /*yield*/, (_a.sent()).json()];
                case 2:
                    resolution_structures = (_a.sent());
                    resolutions = (call !== null) ? resolution_structures.resolutions.filter(function (resolution) { return resolution.call === call; }) : resolution_structures.resolutions;
